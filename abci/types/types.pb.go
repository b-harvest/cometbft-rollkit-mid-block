...
type Request_MidBlock struct {
	MidBlock *RequestMidBlock `protobuf:"bytes,19,opt,name=mid_block,json=midBlock,proto3,oneof" json:"mid_block,omitempty"`
}
...
func (*Request_MidBlock) isRequest_Value()           {}
...
func (m *Request) GetMidBlock() *RequestMidBlock {
	if x, ok := m.GetValue().(*Request_MidBlock); ok {
		return x.MidBlock
	}
	return nil
}
...
type RequestMidBlock struct {
	Txs [][]byte `protobuf:"bytes,1,rep,name=txs,proto3" json:"txs,omitempty"`
}

func (m *RequestMidBlock) Reset()         { *m = RequestMidBlock{} }
func (m *RequestMidBlock) String() string { return proto.CompactTextString(m) }
func (*RequestMidBlock) ProtoMessage()    {}
func (*RequestMidBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{8}
}
func (m *RequestMidBlock) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestMidBlock) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestMidBlock.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestMidBlock) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestMidBlock.Merge(m, src)
}
func (m *RequestMidBlock) XXX_Size() int {
	return m.Size()
}
func (m *RequestMidBlock) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestMidBlock.DiscardUnknown(m)
}

var xxx_messageInfo_RequestMidBlock proto.InternalMessageInfo

func (m *RequestMidBlock) GetTxs() [][]byte {
	if m != nil {
		return m.Txs
	}
	return nil
...
type RequestGenerateFraudProof struct {
	...
	DeliverTxRequests []*RequestDeliverTx `protobuf:"bytes,2,rep,name=deliver_tx_requests,json=deliverTxRequests,proto3" json:"deliver_tx_requests,omitempty"`
	EndBlockRequest   *RequestEndBlock    `protobuf:"bytes,3,opt,name=end_block_request,json=endBlockRequest,proto3" json:"end_block_request,omitempty"`
}
...
func (m *RequestGenerateFraudProof) GetDeliverTxRequests() []*RequestDeliverTx {
	if m != nil {
...
func (m *RequestGenerateFraudProof) GetEndBlockRequest() *RequestEndBlock {
	if m != nil {
...
type Response_MidBlock struct {
	MidBlock *ResponseMidBlock `protobuf:"bytes,20,opt,name=mid_block,json=midBlock,proto3,oneof" json:"mid_block,omitempty"`
}
...
func (*Response_MidBlock) isResponse_Value()           {}
...
func (m *Response) GetMidBlock() *ResponseMidBlock {
	if x, ok := m.GetValue().(*Response_MidBlock); ok {
		return x.MidBlock
	}
	return nil
}
...
func (m *ResponseMidBlock) Reset()         { *m = ResponseMidBlock{} }
func (m *ResponseMidBlock) String() string { return proto.CompactTextString(m) }
func (*ResponseMidBlock) ProtoMessage()    {}
func (*ResponseMidBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{29}
}
func (m *ResponseMidBlock) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseMidBlock) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseMidBlock.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseMidBlock) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseMidBlock.Merge(m, src)
}
func (m *ResponseMidBlock) XXX_Size() int {
	return m.Size()
}
func (m *ResponseMidBlock) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseMidBlock.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseMidBlock proto.InternalMessageInfo

func (m *ResponseMidBlock) GetDeliverTxs() []*ResponseDeliverTx {
	if m != nil {
		return m.DeliverTxs
	}
	return nil
...
func (m *ResponseMidBlock) GetEvents() []Event {
	if m != nil {
		return m.Events
	}
	return nil
...
type FraudProof struct {
	...
	FraudulentDeliverTx  *RequestDeliverTx        `protobuf:"bytes,6,opt,name=fraudulent_deliver_tx,json=fraudulentDeliverTx,proto3" json:"fraudulent_deliver_tx,omitempty"`
	FraudulentEndBlock   *RequestEndBlock         `protobuf:"bytes,7,opt,name=fraudulent_end_block,json=fraudulentEndBlock,proto3" json:"fraudulent_end_block,omitempty"`
}
...
func (m *FraudProof) GetFraudulentDeliverTx() *RequestDeliverTx {
	if m != nil {
...
func (m *FraudProof) GetFraudulentEndBlock() *RequestEndBlock {
	if m != nil {
...
type WitnessData struct {
	Operation Operation         `protobuf:"varint,1,opt,name=operation,proto3,enum=tendermint.abci.Operation" json:"operation,omitempty"`
...
func init() {
	...
	proto.RegisterEnum("tendermint.abci.Operation", Operation_name, Operation_value)
	...
	proto.RegisterType((*RequestMidBlock)(nil), "tendermint.abci.RequestMidBlock")
	...
	proto.RegisterType((*RequestGetAppHash)(nil), "tendermint.abci.RequestGetAppHash")
	proto.RegisterType((*RequestGenerateFraudProof)(nil), "tendermint.abci.RequestGenerateFraudProof")
	proto.RegisterType((*RequestVerifyFraudProof)(nil), "tendermint.abci.RequestVerifyFraudProof")
	...
	proto.RegisterType((*ResponseMidBlock)(nil), "tendermint.abci.ResponseMidBlock")
	...
	proto.RegisterType((*ResponseGetAppHash)(nil), "tendermint.abci.ResponseGetAppHash")
	proto.RegisterType((*ResponseGenerateFraudProof)(nil), "tendermint.abci.ResponseGenerateFraudProof")
	proto.RegisterType((*ResponseVerifyFraudProof)(nil), "tendermint.abci.ResponseVerifyFraudProof")
	...
	proto.RegisterType((*FraudProof)(nil), "tendermint.abci.FraudProof")
	proto.RegisterMapType((map[string]*StateWitness)(nil), "tendermint.abci.FraudProof.StateWitnessEntry")
	proto.RegisterType((*StateWitness)(nil), "tendermint.abci.StateWitness")
	proto.RegisterType((*WitnessData)(nil), "tendermint.abci.WitnessData")
}
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
type ABCIApplicationClient interface {
	...
	MidBlock(ctx context.Context, in *RequestMidBlock, opts ...grpc.CallOption) (*ResponseMidBlock, error)
}
...
func (c *aBCIApplicationClient) GetAppHash(ctx context.Context, in *RequestGetAppHash, opts ...grpc.CallOption) (*ResponseGetAppHash, error) {
	...
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCIApplication/GetAppHash", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIApplicationClient) GenerateFraudProof(ctx context.Context, in *RequestGenerateFraudProof, opts ...grpc.CallOption) (*ResponseGenerateFraudProof, error) {
	...
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCIApplication/GenerateFraudProof", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIApplicationClient) VerifyFraudProof(ctx context.Context, in *RequestVerifyFraudProof, opts ...grpc.CallOption) (*ResponseVerifyFraudProof, error) {
	...
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCIApplication/VerifyFraudProof", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIApplicationClient) MidBlock(ctx context.Context, in *RequestMidBlock, opts ...grpc.CallOption) (*ResponseMidBlock, error) {
	out := new(ResponseMidBlock)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCIApplication/MidBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ABCIApplicationServer interface {
	...
	MidBlock(context.Context, *RequestMidBlock) (*ResponseMidBlock, error)
}
...
func (*UnimplementedABCIApplicationServer) MidBlock(ctx context.Context, req *RequestMidBlock) (*ResponseMidBlock, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MidBlock not implemented")
}
...
func _ABCIApplication_GetAppHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCIApplication/GetAppHash",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ABCIApplication_GenerateFraudProof_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCIApplication/GenerateFraudProof",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ABCIApplication_VerifyFraudProof_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCIApplication/VerifyFraudProof",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ABCIApplication_MidBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestMidBlock)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIApplicationServer).MidBlock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCIApplication/MidBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIApplicationServer).MidBlock(ctx, req.(*RequestMidBlock))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ABCIApplication_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MidBlock",
			Handler:    _ABCIApplication_MidBlock_Handler,
		},
	},
...
func (m *Request_MidBlock) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_MidBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.MidBlock != nil {
		{
			size, err := m.MidBlock.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RequestMidBlock) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestMidBlock) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestMidBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Response_MidBlock) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_MidBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.MidBlock != nil {
		{
			size, err := m.MidBlock.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ResponseMidBlock) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseMidBlock) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseMidBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ResponseApplySnapshotChunk) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RefetchChunks) > 0 {
		dAtA52 := make([]byte, len(m.RefetchChunks)*10)
		var j51 int
...
func (m *Request_MidBlock) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestMidBlock) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_MidBlock) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseMidBlock) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MidBlock", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *RequestMidBlock) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestMidBlock: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestMidBlock: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RequestGenerateFraudProof) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.DeliverTxRequests = append(m.DeliverTxRequests, &RequestDeliverTx{})
		...
		case 3:
			...
			if m.EndBlockRequest == nil {
				m.EndBlockRequest = &RequestEndBlock{}
			}
...
func (m *ResponseMidBlock) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseMidBlock: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseMidBlock: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *FraudProof) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.FraudulentDeliverTx == nil {
				m.FraudulentDeliverTx = &RequestDeliverTx{}
			}
		...
		case 7:
			...
			if m.FraudulentEndBlock == nil {
				m.FraudulentEndBlock = &RequestEndBlock{}
			}
